...
<div class="chart-src f16" role="img" aria-label="Two CoinJoin graphs of sixteen wallets under the same eight deanonymizations.">
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="src/figures/figure-16-dark.svg">
  <img src="src/figures/figure-16-light.svg" alt="Two CoinJoin graphs of sixteen wallets under the same eight deanonymizations: mixing sheds one candidate per strike; merges through a single coin collapse to one.">
</picture>
</div>

*The same eight peers, deanonymized in the same order, in both graphs.*
